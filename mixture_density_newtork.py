...
"""
We cannot use the min square error L2 lost function.
A more suitable loss function is to 
minimise the logarithm of the likelihood of the distribution
"""
...
def get_lossfunc(out_pi,out_simga,out_mu,y):
...
"""
Lastly, if we want, we can try to 
draw the entire mixture pdf at each
point on the x-axis to get a heatmap.
"""
